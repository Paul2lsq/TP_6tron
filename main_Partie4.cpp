...
namespace {
#define GROUP_NAME              "groupe9"
#define MQTT_TOPIC_PUBLISH      "seelec/groupe6/downlink"
#define MQTT_TOPIC_SUBSCRIBE    "seelec/groupe9/downlink"
#define SYNC_INTERVAL           1
#define MQTT_CLIENT_ID          "6LoWPAN_Node_groupe9"
}
...
int main()
{
    ...
    // Yield every 1 secondConnected to MQTT broker ll_every(SYNC_INTERVAL * 1000, yield);
    ...
    // Température
    char temperature[10];
    sprintf(temperature, "%.2f", temp_value); // temp_value est la température lue par ton capteur
    ...
    // Publier sur le feed "temperature" (remplace "temperature" par le nom de ton feed)
    client->publish("Paul2lsq/feeds/temperature", message);
